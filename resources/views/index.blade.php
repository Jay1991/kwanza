      ...
      <div class="row">
        ...
        <div class="col-md-3 col-md-offset-1 hidden-sm hidden-xs text-center">
          <nav data-spy="affix" data-offset-top="0" data-offset-bottom="100" style="position:fixed;">
            <script data-cfasync='false' type='text/javascript' src='//clksite.com/adServe/banners?tid=163359_288755_0&type=slider&size=300x250&position=center&animate=on'></script>
          </nav>
        </div>
      </div>
      {{ $posts->links() }}
